...
public class NewTelephoneCompanyTest_BBT {
	...
	/*
		...
		Invalid st and invalid length			-5				-5				invalid st
												-1				0				invalid st
												2400			-1				invalid st
		Invalid st and discounted length		2401			65				invalid st
		Invalid st and regular length			1578			61				invalid st
												1160			40				invalid st
												1161			1				invalid st
		discounted st and regular length		400				59				1227.20
												0				60				1248.00 
		discounted st and invalid length		799				-5				invalid length
		...
		regular st and discounted length		800				65				2298.40
